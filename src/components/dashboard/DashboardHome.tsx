    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          {/* Available Plans */}
          <Card className="bg-gray-800/50 border-gray-700 p-6">
            <h3 className="text-xl font-bold text-white mb-6">Available AI Plans</h3>
            
            {plans && plans.length > 0 ? (
              <div className="space-y-4">
                {plans.slice(0, 3).map((plan: any) => (
                  <div key={plan.id} className="p-4 bg-gray-700/30 rounded-lg border border-gray-600">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-4">
                          <span className="text-sm text-blue-400">
                            {formatCurrency(Number(plan.min_amount))} - {formatCurrency(Number(plan.max_amount))}
                          </span>
